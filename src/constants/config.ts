...
export const PROMPT =
  "Summarize the following text into 1 to 8 main points, using one bullet point per idea. Each bullet should be short and clear. Prioritize accuracy and relevance. Exclude any references to the news outlet, author, or unrelated stories.";
